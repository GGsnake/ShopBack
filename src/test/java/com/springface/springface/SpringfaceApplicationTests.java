...
//////	@Autowired
//////	EveryGoodService everyGoodService;
//////
//////    @Autowired
...
//	@Test
//	public void stat() throws ApiException {
//        CollectBean c=new CollectBean();
////        c.setAmount("2");
////        c.setCommission("2");
////        c.setSalesVolume("200");
//        collectService.collectTaobao(c);
//	}
////
////>>>>>>> f4031ddb8e636d9bfcfe14cc084e9aa147c7f5b1
////    /**
////     * authkey 必填，你在京东的授权，
////     * unionid 必填，你的联盟Id
...
////	    for (int i=0;i<7;i++){
////            JSONObject jdPid = everyGoodService.createJdPid(500);
////        }
////
////
////    }
